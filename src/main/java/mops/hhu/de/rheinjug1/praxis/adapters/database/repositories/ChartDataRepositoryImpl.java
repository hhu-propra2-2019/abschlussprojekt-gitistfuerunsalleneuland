...
public
class ChartDataRepositoryImpl implements ChartDataRepository { // interface to the view rheinjug1.data_chart needed for statisticts
  // view

  private final NamedParameterJdbcTemplate jdbcTemplate;
  private final ChartDataRowMapper chartDataRowMapper;

  @Override public List<ChartData> getAll() {
