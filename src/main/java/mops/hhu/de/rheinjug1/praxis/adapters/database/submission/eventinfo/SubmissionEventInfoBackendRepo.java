...
public class SubmissionEventInfoBackendRepo {
  ...
  public List<SubmissionEventInfoDTO> getSubmissionInfoListByEmail(final String email) {
    ...
    public List<SubmissionEventInfoDTO> getAllEventsWithUserInfosByEmail(final String email) {
    final MapSqlParameterSource paramSource = new MapSqlParameterSource();
    paramSource.addValue("email", email);
  ...
  public List<SubmissionEventInfoDTO> getAllSubmissionsWithInfos() {
